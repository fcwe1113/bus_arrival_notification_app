...
class BusAlarm {
  ...
  final String operatorRouteId; // linked to the future all routes database with prepended loc code?
  final String gtfsStopId; // same as above
